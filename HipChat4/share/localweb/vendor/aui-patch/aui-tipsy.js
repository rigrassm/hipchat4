  ...
  $.fn.tipsy = function(options) {
    ...
    function enter() {
      ...
      if (options.delayIn == 0) {
        ...
        tipsy.fixTitle();
        clearTimeout(tipsy.enterTimeout);
        tipsy.enterTimeout = setTimeout(function() { if (tipsy.hoverState == 'in') tipsy.show(); }, options.delayIn);
      }
    }
    ...
    function leave() {
      ...
      if (options.delayOut == 0) {
        ...
        clearTimeout(tipsy.leaveTimeout);
        tipsy.leaveTimeout = setTimeout(function() { if (tipsy.hoverState == 'out' && !tipsy.hoverTooltip) tipsy.hide(); }, options.delayOut);
      }
    }
